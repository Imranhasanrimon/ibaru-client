    ...
    return (
        <div className='p-4 max-w-7xl mx-auto'>
            <div className='max-w-2xl mx-auto'>
                <h3 className={`text-2xl sm:text-3xl text-center font-semibold mb-1`}>Institutional Highlights</h3>
                <p className="text-center dark:text-slate-400  text-slate-600 px-4 mb-8">An overview of IBA RU&apos;s achievements, academic excellence, and contributions to business education.</p>
            </div>

            <div className='grid grid-cols-2 md:grid-cols-3 gap-4 text-center'>
                <div className="bg-card p-6 rounded-md border shadow flex flex-col items-center">
